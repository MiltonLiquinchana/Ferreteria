...
//        txtIdEmpleado.setText(IdEmpleado);
    ...
    void agregardatos(int item, String cod, String nom,String descrip,double cant,double cost,double pre,double tot,String iva){
        ...
        if (p>-1){
            ...
            simbolos.setDecimalSeparator('.');
            DecimalFormat formateador = new DecimalFormat("####.####",simbolos);
            String Datos[] = {String.valueOf(item),cod,nom,descrip,String.valueOf(cant),String.valueOf(formateador.format(pre)),String.valueOf(pre),String.valueOf(formateador.format(tot)),String.valueOf(iva)};
    ...
    void CalcularValor_Venta(){
        ...
        for (int f=0; f<fila; f++){
            if(String.valueOf(tblDetalleProducto.getModel().getValueAt(f, 8))=="si"){
               valorVenta += Double.parseDouble(String.valueOf(tblDetalleProducto.getModel().getValueAt(f, 7)))*1.12;             
            }
            else if(String.valueOf(tblDetalleProducto.getModel().getValueAt(f, 8))=="no"){
               valorVenta += Double.parseDouble(String.valueOf(tblDetalleProducto.getModel().getValueAt(f, 7)));             
            }
        }
        txtTotalVenta.setText(String.valueOf(formateador.format(valorVenta)));
    }
            ...
            if(cant>0){
                ...
                if(cant<=stock){
                    ...
                    if (chkiva.isSelected()){
                        d7=Double.parseDouble(txtPrecioProducto.getText())/1.12;
                        d8=Double.parseDouble(txtTotalProducto.getText())/1.12;
                        d9="si";
                    }
                    else{
                        d7=Double.parseDouble(txtPrecioProducto.getText());
                        d8=Double.parseDouble(txtTotalProducto.getText());
                        d9="no";
                    }                
