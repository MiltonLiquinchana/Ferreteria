  ...
  void CrearTabla(){
   ...
   void mirar(){
    ...
    void actualizarTabla(){
       String titulos[]={"ID","Nombre","Apellidos","Sexo","Fecha Nac.","Dirección","Teléfono","Celular","Email","CI","Fecha Ing.","Sueldo","Estado","Usuario","Contraseña","Tipo de Usuario"};
...
//-----------------------ENCRIPTACION - SHA----------------------------------------
    ...
    private void initComponents() {
        ...
        jLabel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Criterios de Búsqueda", 0, 0, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        jLabel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del Empleado", 0, 0, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        jLabel13.getAccessibleContext().setAccessibleName("CI:");
...
//----------------------VALIDACIÓN DE DATOS-------------------------------------
    public boolean validardatos(){
        if (txtNombre.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(null,"Ingrese C.I. del Empleado");
            txtDni.requestFocus();
