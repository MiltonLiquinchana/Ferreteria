  ...
  void CrearTabla(){
   ...
   void modificar(){
    ...
    void actualizarTabla(){
       String titulos[]={"ID","Nombre o Razón Social","RUC","CI","Dirección","Teléfono","Celular","Email","Nº Cuenta 1","Nº Cuenta 2","Estado","Observación"};
   ...
   void BuscarProveedor(){
    ...
    private void initComponents() {
        ...
        jLabel13.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Criterios de Búsqueda", 0, 0, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        jLabel14.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del Proveedor", 0, 0, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        pNuevo.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 535, 335));
