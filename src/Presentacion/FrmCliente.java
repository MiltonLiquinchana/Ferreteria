  ...
  void CrearTabla(){
   ...
   void modificar(){
    ...
    void actualizarTabla(){
       String titulos[]={"ID","Nombre o Razón Social","RUC","CI","Dirección","Teléfono","Observación"};
   ...
   void BuscarCliente(){
    ...
    private void initComponents() {
        ...
        pBuscar.add(rbtnRuc, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 30, 60, -1));

        jLabel10.setBackground(new java.awt.Color(255, 204, 102));
        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel10.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Criterios de Búsqueda", 0, 0, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        jLabel11.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del Cliente", 0, 0, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        pNuevo.add(txtRuc, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 100, 160, -1));
        ...
        pNuevo.add(txtDni, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 100, 130, -1));
...
//----------------------VALIDACIÓN DE DATOS-------------------------------------
    ...
    private void txtRucKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRucKeyTyped
        ...
        if(txtRuc.getText().trim().length()<13){
            ...
            i=12;
            String com=txtRuc.getText().substring(0, 12);
            txtRuc.setText("");
            txtRuc.setText(com);
        }
    ...
    private void txtDniKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDniKeyTyped
        ...
        if(txtDni.getText().trim().length()<10){
            ...
            i=9;
            String com=txtDni.getText().substring(0, 9);
            txtDni.setText("");
            txtDni.setText(com);
        }
