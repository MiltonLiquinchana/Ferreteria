...
public class FrmTipoDocumento extends javax.swing.JInternalFrame {
    ...
    public FrmTipoDocumento() {
        initComponents();
        tabTipoDocumento.setIconAt(tabTipoDocumento.indexOfComponent(pBuscar), new ImageIcon("src/iconos/busca_p1.png"));
        tabTipoDocumento.setIconAt(tabTipoDocumento.indexOfComponent(pNuevo), new ImageIcon("src/iconos/nuevo1.png"));
  ...
  void CrearTabla(){
   ...
   void BuscarTipoDocumento(){
    ...
    private void initComponents() {
        ...
        tabTipoDocumento = new javax.swing.JTabbedPane();
        ...
        rbtnCodigo.setText("ID Tipo de Documento");
        ...
        pBuscar.add(rbtnCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 140, -1));
        ...
        pBuscar.add(rbtnDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 30, 100, -1));
        ...
        tabTipoDocumento.addTab("Buscar", pBuscar);

        pNuevo.setBackground(new java.awt.Color(255, 255, 255));
        pNuevo.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del Tipo de Documento", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        pNuevo.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 11, 440, 330));

        txtCodigo.setEnabled(false);
        pNuevo.add(txtCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 50, 70, 20));

        jLabel3.setText("ID Tipo de Documento:");
        pNuevo.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 120, 20));

        jLabel2.setText("Descripción:");
        pNuevo.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 80, 70, 20));
        ...
        pNuevo.add(txtDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, 180, 20));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(0, 51, 153));
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel12.setText("*");
        pNuevo.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 80, 20, 20));

        jLabel7.setForeground(new java.awt.Color(0, 51, 153));
        jLabel7.setText("Los campos marcado con un asterísco (*) son obligatorios");
        pNuevo.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, 280, -1));

        tabTipoDocumento.addTab("Nuevo / Modificar", pNuevo);

        getContentPane().add(tabTipoDocumento);
        tabTipoDocumento.setBounds(10, 10, 470, 380);
    ...
    if(tblTipoDocumento.getSelectedRows().length > 0 ) { 
        accion="Modificar";
        modificar();
        tabTipoDocumento.setSelectedIndex(tabTipoDocumento.indexOfComponent(pNuevo));
    }else{
        JOptionPane.showMessageDialog(null, "¡Se debe seleccionar un registro!");
    }
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        mirar();
        tabTipoDocumento.setSelectedIndex(tabTipoDocumento.indexOfComponent(pBuscar));
...
//----------------------VALIDACIÓN DE DATOS-------------------------------------
    ...
    private javax.swing.JTabbedPane tabTipoDocumento;
