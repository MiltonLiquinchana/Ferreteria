...
//-----------------------------------------------------------------------------------------------
    void actualizarTablaProducto(){
       String titulos[]={"ID","Cód. de Barras","Nombre","Descripción","Stock","P. Costo","Iva"};
   ...
   //--------------------PRESENTACION DE JTABLE PRODUCTO----------------------
        ...
        TableCellRenderer render = new DefaultTableCellRenderer() { 
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) { 
                ...
                //Determinar Alineaciones   
                    if(column==0 || column==1 || column==4 || column==5 || column==13){
        ...
        int[] anchos = {40,100,150,200,60,60,30};
        for(int i = 0; i < tblProducto.getColumnCount(); i++) {
    ...
    void BuscarProductoPanel(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                Datos[6]=(String) rs.getString(13);
                dtm.addRow(Datos);
                encuentra=true;
    ...
    private void tblProductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblProductoMouseClicked
        ...
        if (fila == -1){
            ...
            defaultTableModel = (DefaultTableModel)tblProducto.getModel();
                ...
                if ("si".equals((String) defaultTableModel.getValueAt(fila,6))){
                    Presentacion.FrmCompra.jCheckiva.setSelected(true);
                }else if ("no".equals((String) defaultTableModel.getValueAt(fila,6))){
                    Presentacion.FrmCompra.jCheckiva.setSelected(false);
                }
        }
